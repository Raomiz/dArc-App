...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D-Nn3W8K.mjs");
...
var manifest = {
	"3d5f16da5c4f0a35ec172fc9ee9b06a604bee01e19f96e5f2b3245289cb97b77": {
		functionName: "listComments_createServerFn_handler",
		importer: () => import("./comments-BNvbdCGL.mjs")
	},
	"4bb6fed79dcea39c3edaada442dc5da628f821f1fb65af1ee6cb21ea19a57ae0": {
		functionName: "addComment_createServerFn_handler",
		importer: () => import("./comments-BNvbdCGL.mjs")
	},
	"626bced988c070e67c2a2d118931cad0b003e5be13c552312d41ff003899290d": {
		functionName: "fetchHouseContext_createServerFn_handler",
		importer: () => import("../__root-CJefmCo7.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BZSromjx.mjs").then((n) => n.t),
