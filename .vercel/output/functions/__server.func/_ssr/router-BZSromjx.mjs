...
import { t as auth } from "./server-D6IIiuIO.mjs";
import { t as TriangleAlert } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BZSromjx.js
...
function AppErrorComponent({ error }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "flex min-h-dvh flex-col items-center justify-center gap-3 bg-void px-6 text-center text-frost",
		children: [
...
var styles_default = "/assets/styles-SrIG6K6J.css";
var APP_NAME = "d’ Arc";
var fetchHouseContext = createServerFn({ method: "GET" }).handler(createSsrRpc("626bced988c070e67c2a2d118931cad0b003e5be13c552312d41ff003899290d"));
var Route$3 = createRootRoute({
	beforeLoad: async () => await fetchHouseContext(),
	head: () => ({
		meta: [
			{ charSet: "utf-8" },
			{
			...
			{
				name: "description",
				content: "Turn thinking into doing."
			},
			{
				name: "theme-color",
				content: "#0c0712"
...
var $$splitComponentImporter$1 = () => import("./routes-DEdTLM-8.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-7rjcW5SF.mjs");
